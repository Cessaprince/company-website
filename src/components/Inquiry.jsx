      ...
      <section className='bg-black py-[50px] h-auto w-full'>
        <div className="short-section">
          <div className="flex flex-col items-center gap-2 text-center">
            ...
            <p className='text-gray-400 font-light text-normal leading-[20px] max-w-[600px] max-md:text-[16px]'>Send us a message if You don't want to book a meeting at this time, and we'll get back to you within 24 hours.</p>
