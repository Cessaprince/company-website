                ...
                <section className="blue-box">
                    <div className="short-section text-white py-[50px]" data-aos='fade-up' data-aos-dealy='100'>
                        <div className="flex flex-col items-center text-center leading-[40px] w-full">
                            ...
                            <p className='text-gray-400 font-light text-base leading-[25px] max-w-[600px] pt-[20px] max-md:leading-[22px] max-md:text-[14px]'>
                        ...
                        <div className="w-full h-[600px] overflow-hidden mt-[50px] rounded-[15px] border-[1px] max-md:h-[250px]">
                ...
                <section className='bg-black py-[50px]'>
                    <div className="short-section flex flex-col gap-[40px]" data-aos='fade-up' data-aos-dealy='100'>
                        <div className="flex items-center justify-center gap-[40px] max-md:flex-col">
                            ...
                            <div className="flex flex-col gap-[10px] flex-1  max-md:gap-[5px]">
                                <div className="flex gap-[10px] items-center">
                                    ...
                                    <h3 className='text-white capitalize font-black text-[30px] max-md:text-[26px]'>foodbank</h3>
                                </div>
                                <p className='text-gray-400 font-light text-sm leading-[25px] max-w-[600px] pt-[20px] max-md:text-[13px]'>
                        ...
                        {/* go shortlet*/}
                        <div className="flex items-center justify-center gap-[40px] max-md:flex-col max-md:mt-[40px]">
                            ...
                            <div className="flex flex-col gap-[10px] flex-1 max-md:gap-[5px]">
                                <div className="flex gap-[10px] items-center">
                                    ...
                                    <h3 className='text-white uppercase font-black text-[30px] max-md:text-[26px]'>go shortlet</h3>
                                </div>
                                <p className='text-gray-400 font-light text-sm leading-[25px] max-w-[600px] pt-[20px] max-md:text-[13px]'>
                                    Foodbank ensures uninterrupted nutrition, shielding you from financial uncertainty. Our outright provisions grant stable access to wholesome meals, unaffected by life's financial ups and downs. Foodbank ensures uninterrupted nutrition, shielding you from financial uncertainty. Our outright provisions grant stable access to wholesome meals, unaffected by life's financial ups and downs. Foodbank ensures uninterrupted nutrition, shielding you from financial uncertainty. Our outright provisions grant stable access to wholesome meals, unaffected by life's financial ups and downs
                                </p>
                ...
                <section className='bg-black py-[100px] max-md:py-[50px]'>
                    <div className="short-section" data-aos='fade-up' data-aos-dealy='100'>
                        ...
                        <div className="flex flex-col items-center gap-2 text-center">
                            ...
                            <p className='text-gray-400 font-light text-normal leading-[20px] w-[70%] max-md:w-[100%] max-md:text-[14px]'>Sovereign provides services to organizations across industries seeking to operate smarter, grow faster, and make better decisions through structured systems and data-driven intelligence.

                            </p>
                        </div>

                        <div className="flex items-center gap-[30px] my-[60px] max-md:flex-col">
                            <div className="blue-box w-[50%] h-full py-[60px] px-[30px] rounded-[15px] border-[0.1px] border-gray-600 max-md:w-[100%]">
                            ...
                            <div className="flex flex-col flex-1 gap-[12px] max-md:w-full">
                                ...
                                <div onClick={() => scrollToSection("myHeader")} className="flex justify-between items-center bg-[var(--dark-blue2)] hover:cursor-pointer p-[16px] border-[0.1px] border-gray-700 rounded-[15px] hover:border-[var(--dark-orange)]">
                                    ...
                                    <div className="flex flex-col leading-[20px]">
                                        <h3 className='text-white font-light text-[15px] max-md:text-[14px]'>Growing startups</h3>
                                        <p className='text-gray-400 text-sm font-light text-normal leading-[20px] w-[70%] max-md:w-[100%] max-md:text-[12px]'>All sector </p>
                                    </div>
                                ...
                                <div onClick={() => scrollToSection("myHeader")} className="flex justify-between hover:cursor-pointer items-center bg-[var(--dark-blue2)] p-[16px] border-[0.1px] border-gray-700 rounded-[15px] hover:border-[var(--dark-orange)]">
                                    ...
                                    <div className="flex flex-col leading-[20px]">
                                        <h3 className='text-white font-light text-[15px] max-md:text-[14px]'>Small and medium-sized</h3>
                                        <p className='text-gray-400 text-sm font-light text-normal leading-[20px] w-[70%] max-md:w-[100%] max-md:text-[12px]'>All sector </p>
                                    </div>
